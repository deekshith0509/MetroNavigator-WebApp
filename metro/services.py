...
class MetroService:
    ...
    def _get_journey_details(self, path, mode):
        ...
        for i in range(len(path) - 1):
            ...
            # Look ahead to determine if this is a real line change
            is_necessary_interchange = False
    ...
    def visualize_metro_map(self, source, destination, current_mode):
        try:
            ...
            path_edges = []
            if path_details:
                path_nodes = path_details['path']  # Assume this contains the list of nodes in the path
            ...
            nx.draw_networkx_edges(G, pos, edgelist=path_edges, edge_color='orange', width=3)  # Use orange color for the path
